...
<body class="bg-gradient-to-br from-purple-600 to-purple-800 min-h-screen flex items-center justify-center p-3 sm:p-5">
    <div class="flex flex-col lg:flex-row max-w-4xl w-full bg-white rounded-xl lg:rounded-2xl overflow-hidden shadow-2xl">
        ...
        <div class="hidden lg:flex flex-1 bg-gradient-to-br from-purple-600 to-purple-800 p-8 xl:p-12 text-white flex-col justify-center">
            ...
            <h2 class="text-2xl xl:text-3xl font-bold mb-3 lg:mb-4">Selamat Datang Kembali!</h2>
            ...
            <div class="mt-8 space-y-4">
                ...
                <div class="flex items-center gap-3">
                    <div class="w-6 h-6 bg-white bg-opacity-20 rounded-full flex items-center justify-center text-sm font-bold">✓</div>
                    <span>Mudah dikelola & ramah UMKM</span>
                </div>
                <div class="flex items-center gap-3">
                    <div class="w-6 h-6 bg-white bg-opacity-20 rounded-full flex items-center justify-center text-sm font-bold">✓</div>
                    <span>Dukungan pembayaran lengkap</span>
                </div>
                <div class="flex items-center gap-3">
                    <div class="w-6 h-6 bg-white bg-opacity-20 rounded-full flex items-center justify-center text-sm font-bold">✓</div>
                    <span>Biaya rendah, profit maksimal</span>
                </div>
            </div>
        </div>

        <!-- Right Section -->
        <div class="flex-1 p-6 sm:p-8 lg:p-10 xl:p-12">
            <!-- Mobile Logo -->
            ...
            @if ($errors->any())
                <div class="mb-4 sm:mb-5 bg-red-50 border-l-4 border-red-500 p-3 sm:p-4 rounded">
                    <div class="flex items-center">
                        <span class="text-red-500 mr-2 text-lg sm:text-xl">⚠️</span>
            ...
            @if (session('success'))
                <div class="mb-4 sm:mb-5 bg-green-50 border-l-4 border-green-500 p-3 sm:p-4 rounded">
                    <div class="flex items-center">
                        <span class="text-green-500 mr-2 text-lg sm:text-xl">✓</span>
            ...
            <form method="POST" action="{{ route('login.post') }}">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-5 gap-2 sm:gap-0">
                    <label class="flex items-center cursor-pointer">
                        <input type="checkbox" name="remember" class="w-3.5 h-3.5 sm:w-4 sm:h-4 text-purple-600 border-gray-300 rounded focus:ring-purple-500">
                        <span class="ml-2 text-xs sm:text-sm text-gray-600">Ingat saya</span>
                    </label>
                    <a href="{{ url('/forgot-password') }}" class="text-purple-600 text-xs sm:text-sm hover:underline">
                        Lupa Password?
                    </a>
                </div>
            ...
            <div class="relative my-5 sm:my-6">
                ...
                <div class="relative flex justify-center text-xs sm:text-sm">
                    <span class="px-3 sm:px-4 bg-white text-gray-500">atau masuk dengan</span>
                </div>
            </div>

            <!-- Google Login Button -->
            <a href="{{ route('auth.google') }}" 
                class="w-full flex items-center justify-center gap-2 sm:gap-3 bg-white border-2 border-gray-300 text-gray-700 py-2.5 sm:py-3 rounded-lg text-xs sm:text-base font-semibold hover:bg-gray-50 hover:shadow-md transition">
                <svg class="w-4 h-4 sm:w-5 sm:h-5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="text-center text-gray-600 text-xs sm:text-sm mt-5 sm:mt-6">
                Belum punya akun? 
