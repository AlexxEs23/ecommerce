...
<body class="bg-gradient-to-br from-purple-600 to-purple-800 min-h-screen flex items-center justify-center p-5">
    <div class="flex max-w-4xl w-full bg-white rounded-2xl overflow-hidden shadow-2xl">
        <!-- Left Section -->
        <div class="flex-1 bg-gradient-to-br from-purple-600 to-purple-800 p-12 text-white flex flex-col justify-center">
            <div class="text-3xl font-bold mb-5 flex items-center gap-2">
                <span class="text-4xl">🛒</span>
                UMKM Market
            </div>
            <h2 class="text-3xl font-bold mb-4">Mulai Berjualan Sekarang!</h2>
        ...
        <!-- Right Section -->
        <div class="flex-1 p-12 overflow-y-auto max-h-screen">
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-800 mb-2">Buat Akun Baru</h1>
                <p class="text-gray-600 text-sm">Lengkapi formulir di bawah untuk mendaftar</p>
            </div>
