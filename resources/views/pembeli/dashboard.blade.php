            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-md p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <!-- Pesanan Saya -->
                        <a href="{{ route('pembeli.pesanan') }}" class="group bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 hover:shadow-lg transition border-2 border-transparent hover:border-blue-500">
                ...
                <div class="bg-white rounded-xl shadow-md p-6">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="{{ route('pembeli.pesanan') }}" class="text-purple-600 hover:text-purple-700 font-semibold text-sm">
                            Lihat Semua →
                        </a>
                    </div>
                                    ...
                                    <div class="flex gap-4">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="flex items-center justify-between">
                                                ...
                                                <a href="{{ route('pembeli.pesanan') }}" class="px-4 py-1 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition text-sm">
                                                    Lihat Detail
                                                </a>
                                            </div>
